...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue added people to the wrong end of the queue (turning the queue into a stack)
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: TakingTurnsQueue.GetNextPerson lacked special handling for infinite-queueueueueuers (resulting in immediate removal)
